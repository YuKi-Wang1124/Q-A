...
class ViewController: UIViewController {
    ...
    func caculateScore() {
        if score >= 80 {
            alert(title: "總分 \(score) 分", message: "太厲害了！", buttonText: "再玩一次！")
        } else if score >= 60 && score < 80 {
            alert(title: "總分 \(score) 分", message: "很棒喔！", buttonText: "再玩一次！")
        } else if score >= 30 && score < 60 {
            alert(title: "總分 \(score) 分", message: "加油喔！", buttonText: "再玩一次！")
        } else {
            alert(title: "總分 \(score) 分", message: "還要再努力！", buttonText: "再玩一次！")
            }
        }
